import { BOOKMARKS_RETRY_CONFIG, fetchXArticle } from "./graphql";
import type { RetryConfig } from "./graphql";
import type { ArticleEntity, XCookieMap } from "./x-types";
...
export async function resolveArticleEntityFromTweet(
  ...
  const fetched = await fetchXArticle(articleId, cookieMap, false, retryConfig);
